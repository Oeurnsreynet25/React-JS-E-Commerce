...
function Men() {
  ...
  useEffect(() => {
    fetch('https://fakestoreapi.com/products/category/men\'s%20clothing') // Correct category URL
  ...
  if (loading) {
    return <p>Loading men's products...</p>;
  }
      ...
      <div className="container">
        <div className="row">
          <div className="display-header d-flex justify-content-between pb-3">
            <h2 className="display-7 text-dark text-uppercase">Men's Clothes</h2>
